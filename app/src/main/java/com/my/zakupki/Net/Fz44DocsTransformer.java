...
/**
 * Created by Dariya on 14.04.2017.
 */

public class Fz44DocsTransformer extends BaseTreeResultTransformer {
    public Fz44DocsTransformer(TreeNode<BaseParsingRule> aRuleTree) {
        super(aRuleTree);
    }
